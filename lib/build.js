...
var build = function(cannerJson, options, watchOpt) {
  ...
  return generate.doc(output, cannerJson, tmp_engine, options);
};

var _regenerateDoc = function(monitor, dir, cannerJson, output, options, filter) {
  var rebuildAndWatch= function (cannerJson) {
    var buildPromise= generate.doc(output, cannerJson, tmp_engine, options)
